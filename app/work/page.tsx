						...
						<div className="max-w-360! mx-auto!">
							...
							<div className="grid! grid-cols-1! md:grid-cols-3! gap-6! mt-14! items-stretch!">
								{[
									...
									{ src: "/logo/img4.jpg", title: "Identity Mark 2" },
									{ src: "/logo/img5.jpg", title: "Identity Mark 3" },
								].map((logo) => (
									<Link
										key={logo.src}
										href="/logo"
										className="relative! block! overflow-hidden! rounded-lg! border! border-[rgba(242,237,230,0.07)]! group! h-70! md:h-90! cursor-pointer!"
									>
										<Image
											src={logo.src}
											alt={logo.title}
